...
export default function CarDetail3() {
    return(
        <div className="text-center item-center bg-gray-100 ">
            <h1 className="font-bold text-2xl underline mt-5">Honda City 2024 Price In Pakistan,Images,Reviews & Specs</h1>
            <Image src={honda2img} alt="toyota" className="h-64 w-64 mx-96 my-10" />
