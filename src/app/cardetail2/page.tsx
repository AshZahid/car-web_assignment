...
export default function CarDetail2() {
    return(
        <div className="text-center item-center bg-gray-100 ">
            <h1 className="font-bold text-2xl underline mt-5">Suzuki Alto 2024 Price In Pakistan,Images,Reviews & Specs</h1>
            <Image src={altoimg} alt="toyota" className="h-64 w-64 mx-96 my-10" />
